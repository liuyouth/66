 ...
 * Generated at: 2016-07-08 03:04:53 UTC
...
return;
	...
	request.setAttribute("basePath", basePath);
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/recipient/list/view\">收货人管理</a></li>\r\n");
      out.write("\t\t\t\t<li class=\"am-active\">新增收货人</li>\r\n");
      out.write("\t\t\t</ol>\r\n");
      out.write("\t\t\t<hr class=\"wm-hr\">\r\n");
      out.write("\t\t\t<!-- context start -->\r\n");
      out.write("\t\t\t<div class=\"am-u-sm-10 am-u-sm-centered\">\r\n");
      out.write("\t\t\t\t<form id=\"addForm\" class=\"am-form wm-form am-form-horizontal\" method=\"post\" >\r\n");
      out.write("\t\t\t\t\t<div class=\"am-panel am-panel-primary wm-panel\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"am-panel-hd\">新增收货人</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"am-panel-bd\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"am-form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"am-u-sm-3 am-form-label\"> 收货人名称<span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"am-text-danger\">&nbsp;*</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"am-u-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"recipientName\" maxlength=\"50\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdatatype=\"*\" ajaxurl=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/recipient/unique\" placeholder=\"请输入收货人名称\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"am-form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"am-u-sm-3 am-form-label\"> 收货人简称<span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"am-text-danger\">&nbsp;*</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"am-u-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"recipientCode\" maxlength=\"20\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdatatype=\"*\" placeholder=\"请输入收货人简称\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"am-form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"am-u-sm-3 am-form-label\"> 收货地址<span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"am-text-danger\">&nbsp;*</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"am-u-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"recipientAddress\" maxlength=\"100\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdatatype=\"*\" placeholder=\"请输入收货地址\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"am-form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"am-u-sm-3 am-form-label\"> 联系人<span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"am-text-danger\">&nbsp;*</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"am-u-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"recipientContact\" maxlength=\"20\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdatatype=\"*\" placeholder=\"请输入联系人\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"am-form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"am-u-sm-3 am-form-label\"> 联系电话<span\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"am-text-danger\">&nbsp;*</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"am-u-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"recipientContactPhone\" maxlength=\"20\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdatatype=\"m\" placeholder=\"请输入联系电话\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\tsrc=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/js/app/recipient/add.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
