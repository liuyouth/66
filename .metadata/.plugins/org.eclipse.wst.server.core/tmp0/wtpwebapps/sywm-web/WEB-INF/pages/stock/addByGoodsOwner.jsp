...
<body class="am-container wm-container">
	...
	<div class="am-g">
		...
		<div class="am-u-sm-9">
			<ol class="am-breadcrumb wm-breadcrumb">
				...
				<li class="am-active">新增盘库单(按货主盘货)</li>
			</ol>
			<hr class="wm-hr">
			<!-- context start -->
			<div class="am-u-sm-10 am-u-sm-centered">
				<div class="am-panel am-panel-primary wm-panel">
					<div class="am-panel-hd">新增盘库单(按货主盘货)</div>
					<div class="am-panel-bd">
						<form id="addForm" class="am-form wm-form am-form-horizontal">
							...
							<div class="am-form-group">
								<label class="am-u-sm-3 am-form-label">
									选择货主<span class="am-text-danger">&nbsp;*</span>
								</label>
								<div class="am-u-sm-9 am-input-group">
									<input type="text" class="am-form-field" placeholder="请选择货主">
								</div>
							</div>
						</form>
					</div>
	...
	<script type="text/javascript" src="${basePath }/js/app/stock/addByGoodsOwner.js"></script>
</body>
</html>