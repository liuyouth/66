...
<body class="am-container wm-container">
					...
					<footer class="am-panel-footer">
						<div class="am-g">
							...
							<div class="am-u-sm-9" style="text-align:right;">
								<button type="button" class="am-btn am-btn-default" onclick="javascript:void(0)">打印</button>
	...
	<script type="text/javascript" src="${basePath }/js/app/goods_receipt/arrivalGoodsDetail.js"></script>
</body>
</html>