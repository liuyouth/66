...
<body class="am-container wm-container">
	...
	<div class="am-g">
		...
		<div class="am-u-sm-9">
			<ol class="am-breadcrumb wm-breadcrumb">
				...
				<li class="am-active">编辑分拣单</li>
			</ol>
			<hr class="wm-hr">
			<!-- context start -->
			<div class="am-u-sm-10 am-u-sm-centered">
				<div class="am-panel am-panel-primary wm-panel">
					<div class="am-panel-hd">编辑分拣单</div>
					<div class="am-panel-bd">
						<form id="editForm" class="am-form wm-form am-form-horizontal">
							<div class="am-form-group">
								<label class="am-u-sm-3 am-form-label"> 分拣单号 </label>
								<div class="am-u-sm-9">
									<label class="am-form-label">FJ001</label>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" placeholder="请输入分拣负责人" value="赵五">
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" placeholder="请输入司机姓名" value="赵五">
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" placeholder="请输入车牌号" value="京B123456">
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" placeholder="请输入月台编号" value="一号月台">
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" class="wm-Wdate" readonly="readonly"
	...
	<script type="text/javascript"
		src="${basePath }/js/app/sorting/sortingEdit.js"></script>
</body>
</html>