...
<body class="am-container wm-container">
	...
	<div class="am-g">
		...
		<div class="am-u-sm-9">
			<ol class="am-breadcrumb wm-breadcrumb">
				...
				<li class="am-active">新增账号</li>
			</ol>
			<hr class="wm-hr">
			<!-- context start -->
			<div class="am-u-sm-10 am-u-sm-centered">
				<div class="am-panel am-panel-primary wm-panel">
					<div class="am-panel-hd">新增账号</div>
					<div class="am-panel-bd">
						<form id="addForm" class="am-form wm-form am-form-horizontal">
							...
							<div class="am-form-group">
								<label class="am-u-sm-3 am-form-label">账号<span class="am-text-danger">&nbsp;*</span></label>
								<div class="am-u-sm-9">
	...
	<script type="text/javascript" src="${basePath }/js/app/goods_owner/goods_owner_user/add.js"></script>
</body>
</html>