...
<body class="am-container wm-container">
	...
	<div class="am-g">
		...
		<div class="am-u-sm-9">
			<ol class="am-breadcrumb wm-breadcrumb">
				...
				<li><a href="${basePath}/goods_receipt/arrivalPlanList/view">到货计划</a></li>
				<li class="am-active">查看到货计划详细信息</li>
			</ol>
			<hr class="wm-hr">
			<!-- context start -->
	...
	<script type="text/javascript" src="${basePath }/js/app/goods_receipt/arrivalPlanDetail.js"></script>
</body>
</html>