...
public class StorageAreasServiceImpl extends BaseServiceImpl implements StorageAreasService {
	...
	public void add(Map<String, String> params) throws Exception {
		...
		sywmClient.post(SYWMStorageAreasPath.Add, params);
	}

	@Override
	public String edit(Map<String, String> params) throws Exception {

		return sywmClient.post(SYWMStorageAreasPath.Edit, params);
	}

	@Override
	public void update(Map<String, String> params) throws Exception {

		sywmClient.post(SYWMStorageAreasPath.Update, params);
	}

	@Override
	public String queryKV() throws Exception {

		return sywmClient.post(SYWMStorageAreasPath.KV);
	}

	@Override
	public String selectAllAreas(Map<String, String> params) throws Exception {
		String filterString = "[\"storageAreasId\",\"areasName\",\"areasColor\"]";
		params.put("filterString", filterString);
		return sywmClient.post(SYWMStorageAreasPath.SelectAllAreas, params);
	}
