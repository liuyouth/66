...
<body class="am-container wm-container">
	...
	<div class="am-g">
		...
		<div class="am-u-sm-9">
			<ol class="am-breadcrumb wm-breadcrumb">
				...
				<li class="am-active">新增盘库单(按库区盘货)</li>
			</ol>
			<hr class="wm-hr">
			<!-- context start -->
			<div class="am-u-sm-10 am-u-sm-centered">
				<div class="am-panel am-panel-primary wm-panel">
					<div class="am-panel-hd">新增盘库单(按库区盘货)</div>
						...
						<div class="am-g">
							<div class="am-u-sm-12" style="text-align: left;">
								<div class="wm-inner-table-title">
									<label class="wm-inner-table-title-label">盘库库区详情</label>
									<button title="添加库区" type="button" class="am-btn am-btn-default" onclick="javascript:void(0)">
										<span class="am-icon-plus"></span> 添加库区
									</button>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="${basePath }/js/app/stock/addByGoodsLocator.js"></script>
</body>
</html>