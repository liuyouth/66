	...
	<div class="am-g">
		...
		<div class="am-u-sm-9">
			...
			<div class="am-btn-group" style="margin-bottom: 5px;">
				<button title="添加二次包装商品" type="button" class="am-btn am-btn-default" onclick="javascript:void(0);">
					<span class="am-icon-plus"></span> 添加二次包装商品
				</button>
				<button title="添加车辆" type="button" class="am-btn am-btn-default" onclick="javascript:void(0);">
...
<script type="text/javascript" src="${basePath }/js/app/deliver_goods/edit.js"></script>	
</body>
</html>