...
<body class="am-container wm-container">
		...
		<div class="am-u-sm-9">
			...
			<div class="am-u-sm-10 am-u-sm-centered">
				<div class="am-panel am-panel-primary wm-panel">
					<div class="am-panel-hd">销毁信息</div>
						...
						<div class="am-g">
							<div class="am-u-sm-12" style="text-align: left;">
								<div class="wm-inner-table-title">
									<label class="wm-inner-table-title-label">报损详情</label>
								</div>
							</div>
						</div>
					...
					<footer class="am-panel-footer">
						<div class="am-g">
							...
							<div class="am-u-sm-9" style="text-align:right;">
								<button type="button" class="am-btn am-btn-primary">销毁</button>
	...
	<script type="text/javascript" src="${basePath }/js/app/destroy/detail.js"></script>
</body>
</html>