...
public class DriverController extends BaseController {
	...
	public DataTableInfo search(@RequestParam Map<String, String> params) throws Exception {
		...
		// 数据
		List<Map<String, String>> list = driverService.search(params);
	...
	@RequestMapping("del/{driverId}")
	public ResultInfo del(@PathVariable("driverId") String driverId) {

		ResultInfo resultInfo = new ResultInfo();
		try {
			driverService.del(driverId);
	...
	@RequestMapping("read/{driverId}")
	public ResultInfo read(@PathVariable("driverId") String driverId) {
		...
		try {
			...
			ObjectMapper objectMapper = new ObjectMapper();
			String result = driverService.read(params);
	...
	public ResultInfo updata(@RequestParam Map<String, String> params) {
		...
		ObjectMapper objectMapper = new ObjectMapper();
		try {
			resultInfo = objectMapper.readValue(driverService.updata(params), ResultInfo.class);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			resultInfo.setMsg(MessageConst.OPERATE_FAIL);
