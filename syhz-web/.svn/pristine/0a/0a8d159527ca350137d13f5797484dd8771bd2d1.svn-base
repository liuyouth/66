...
<body class="am-container wm-container">
			...
			<div class="am-u-sm-10 am-u-sm-centered">
				<form id="addForm" class="am-form wm-form am-form-horizontal"
					...
					<div class="am-panel am-panel-primary wm-panel">
						<div class="am-panel-hd">编辑收货人</div>
						<div class="am-panel-bd">
							<div class="am-form-group">
								<label class="am-u-sm-3 am-form-label"> 收货人名称
								</label>
								<div class="am-u-sm-9">
									<input type="hidden" name="recipientId">
									<label class="am-form-label" data-name-wm="recipientName">
								</div>
							</div>
							<div class="am-form-group">
	...
	<script type="text/javascript"
		src="${basePath }/js/app/recipient/edit.js"></script>
</body>
</html>