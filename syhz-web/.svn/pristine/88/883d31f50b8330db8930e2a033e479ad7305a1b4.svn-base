...
import com.rescam.syhz.web.util.MessageConst;
...
public class RecipientController extends BaseController {
	 ...
	 * @return 数据信息 / 系统错误！
	 */
	@RequestMapping("/read/{recipientid}")
	public ResultInfo read(@PathVariable("recipientid") String recipientid) {
	...
	// 批量删除
	@RequestMapping("/delete/{recipientId}")
	public ResultInfo dels(@PathVariable("recipientid") String recipientid) {
