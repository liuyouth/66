package com.rescam.sywm.server.utils;
 ...
 * 比较安全的做法就是使用hash+salt的加密算法。 这里使用了RFC2898标准。 This implementation follows RFC
 * 2898 recommendations. See http://www.ietf.org/rfc/Rfc2898.txt
 * 
 * @author li-si
 *
 */
